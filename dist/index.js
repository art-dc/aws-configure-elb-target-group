...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.configureTargetGroup = exports.createTargetGroup = exports.describeTargetGroup = void 0;
...
function describeTargetGroup(name) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const ecs = getClient();
        try {
...
exports.describeTargetGroup = describeTargetGroup;
...
function configureTargetGroup(inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        const { name } = inputs;
        let targetGroup = yield describeTargetGroup(name);
        if (!targetGroup)
            targetGroup = yield createTargetGroup(inputs);
        return targetGroup;
    });
}
exports.configureTargetGroup = configureTargetGroup;
//# sourceMappingURL=target-group-management.js.map
